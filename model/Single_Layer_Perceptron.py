...
for i in range(990, 1000, 10):
    for param1 in range(1000, 11000, 1000):
        r = i/1000
        ...
        print(results)
        model_result1 = open(
            'C:/Users/GomZoo/PycharmProjects/제대로/model_evaluate_최종/test_5월8천모두1층99/train_8만/컨벌_배치{}/{:.2f}/정답률{}%_가중치{:.2f}% 인자1 {}.txt'.format(
                sz, r, round(results[1] * 100, 2), r, param1), 'w', encoding='utf-8')  # 테스트 결과를 출력할 파일
        graph_data = open('C:/Users/GomZoo/PycharmProjects/제대로/model_evaluate_최종/test_5월8천모두1층99/train_8만/컨벌_배치{}_{:.2f}.txt'.format(sz, r), 'a', encoding='utf-8')
        graph_data.write("{} {}\n".format(param1, round(results[1], 3)))
